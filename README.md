...
#### Parallelization of [travelling salesman problem (TSP)](http://en.wikipedia.org/wiki/Travelling_salesman_problem) using [PyCSP](https://github.com/runefriborg/pycsp)
